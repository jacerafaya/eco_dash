    ...
    return (
        <div className="grid">
            <div className="col-12">
                <div className="card">
                    <h5><i className='pi pi-fw pi-user'></i>     Les Informations des personnes ayant rempli le formulaire</h5>
                    <DataTable
                        value={customers1}
                        paginator
                    ...
                    >
                        <Column field="name" header="Nom" filter filterPlaceholder="Search by name" style={{ minWidth: '8rem' }} />
